...
public:
	...
	//Sub mipmap setting on or off
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = LevelOfDetail)
		bool bUseSubMipGenSettings;

	//Sub mipmap setting start mip level
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = LevelOfDetail, meta = (DisplayName = "Sub Mip Get Settings Start Lod"))
		uint8 SubMipStartLevel;

	//Sub mipmap setting option
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = LevelOfDetail)
		TEnumAsByte<enum TextureMipGenSettings> SubMipGenSettings;
