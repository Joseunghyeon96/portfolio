...
public:
	...
	void GetMipGenSettings( const UTexture& Texture, TextureMipGenSettings Setting,TextureMipGenSettings& OutMipGenSettings, float& OutSharpen, uint32& OutKernelSize, bool& bOutDownsampleWithAverage, bool& bOutSharpenWithoutColorShift, bool &bOutBorderColorBlack ) const;
